                    ...
                    <div class="col-lg-12 grid-margin stretch-card"> 
                        <div class="card"> 
                            <div class="card-body"> 
                              ...
                              <a style="max-width: 150px; float: left; display:inline-block;" href="{{ url('admin/add-edit-banner') }}" 
                              ...
                              @foreach ($banners as $banner)
                                <tr> 
                                     ...
                                     <td> @if($banner['status']==1)   &nbsp;
                                            <a title="Active" class="updateBannerStatus" id="banner-{{$banner['id']}}" banner_id="{{$banner['id']}}"
                                                href="javascript:void(0)"> 
                                            <i style="font-size:30px" class="mdi mdi-check-circle" status="Active"> </i> </a>
                                          @else  &nbsp;
                                          <a title="Inactive" class="updateBannerStatus" id="banner-{{$banner['id']}}" banner_id="{{$banner['id']}}"
                                                href="javascript:void(0)"> 
                                            <i style="font-size:30px" class="mdi mdi-check-circle-outline" status="Inactive"> </i> </a>
                                          @endif
                                    </td>                      
                                     <td>    &nbsp;
                                         <a title="Edit Banner" href="{{ url('admin/add-edit-banner/'.$banner['id']) }}">
                                         <i style="font-size:30px" class="mdi mdi-lead-pencil"> </i> </a> &nbsp; &nbsp;  &nbsp;
                                         <a title="Delete Banner"  href="javascript:void(0)" class="confirmDelete" module="banner" moduleid="{{$banner['id']}}">
